    ...
    <div class="page-content page-home">
        ...
        <section class="store-new-products">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-6 col-md-4 col-lg-3 card product-thumbnail" data-aos="fade-up" data-aos-delay="100">
                        <a href="/details.html" class="component-products d-block">
                            <div class="card-img">
                                <img class="card-img-top product-image" src="/images/products-apple-watch.jpg" alt="" />
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 card product-thumbnail" data-aos="fade-up" data-aos-delay="200">
                        <a href="/details.html" class="component-products d-block">
                            <div class="card-img">
                                <img
                                class="card-img-top product-image"
                    ...
                    <div class="col-6 col-md-4 col-lg-3 card product-thumbnail" data-aos="fade-up" data-aos-delay="300">
                        <a href="/details.html" class="component-products d-block">
                            <div class="card-img">
                                <img
                                class="card-img-top product-image"
                    ...
                    <div class="col-6 col-md-4 col-lg-3 card product-thumbnail" data-aos="fade-up" data-aos-delay="400">
                        <a href="/details.html" class="component-products d-block">
                            <div class="card-img">
                                <img
                                class="card-img-top product-image"
